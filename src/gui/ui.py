...
#    Sep 14, 2021 01:42:18 AM JST  platform: Windows NT
...
class MainForm:
    def __init__(self, top=None):
        ...
        self.Auto_Send.configure(variable=ui_support.che51)
        ...
        self.Auto_Clear_Log.configure(variable=ui_support.che56)

        self.Progress = ttk.Progressbar(top)
        self.Progress.place(relx=0.0, rely=0.957, relwidth=1.0, relheight=0.0
                            , height=24)
        ...
        self.Send_Encoding.configure(state='readonly')
        self.Send_Encoding.configure(textvariable=ui_support.combobox)
        self.Send_Encoding.configure(takefocus="")
        self.Send_Encoding.configure(cursor="hand2")

        self.Receive_Encoding_1 = ttk.Combobox(top)
        self.Receive_Encoding_1.place(relx=0.626, rely=0.143, relheight=0.049
                                      , relwidth=0.359)
        self.value_list = ['<Put', 'the', 'same', 'encoding', 'items>', ]
        self.Receive_Encoding_1.configure(values=self.value_list)
        self.Receive_Encoding_1.configure(exportselection="0")
        self.Receive_Encoding_1.configure(state='readonly')
        self.Receive_Encoding_1.configure(textvariable=ui_support.combobox)
        self.Receive_Encoding_1.configure(takefocus="")
        self.Receive_Encoding_1.configure(cursor="hand2")
        ...
        self.Send_One.configure(variable=ui_support.che56)
        ...
        self.Max_Speed = tk.Spinbox(top, from_=-1.0, to=2147483647.0)
        self.Max_Speed.place(relx=0.842, rely=0.246, relheight=0.045
                             , relwidth=0.092)
        self.Max_Speed.configure(activebackground="#f9f9f9")
        self.Max_Speed.configure(background="white")
        self.Max_Speed.configure(buttonbackground="#d9d9d9")
        self.Max_Speed.configure(disabledforeground="#a3a3a3")
        self.Max_Speed.configure(font="TkDefaultFont")
        self.Max_Speed.configure(foreground="black")
        self.Max_Speed.configure(highlightbackground="black")
        self.Max_Speed.configure(highlightcolor="black")
        self.Max_Speed.configure(insertbackground="black")
        self.Max_Speed.configure(selectbackground="blue")
        self.Max_Speed.configure(selectforeground="white")
        self.Max_Speed.configure(textvariable=ui_support.spinbox)

        self.Slash_Sec = tk.Label(top)
        self.Slash_Sec.place(relx=0.936, rely=0.256, height=21, width=24)
        self.Slash_Sec.configure(background="#d9d9d9")
        self.Slash_Sec.configure(disabledforeground="#a3a3a3")
        self.Slash_Sec.configure(foreground="#000000")
        self.Slash_Sec.configure(text='''b/s''')
        ...
        self.Port.configure(textvariable=ui_support.spinbox)
        ...
        self.Input_Guide.configure(cursor="fleur")
        ...
        self.Input.place(relx=0.021, rely=0.355, relheight=0.158, relwidth=0.965)
